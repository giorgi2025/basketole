...
const MyContributionIcon = (props) => {
    return (
        <svg width="24px" height="20px" viewBox="0 0 26 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <title>My Contribution</title>
            <desc></desc>
            <g id="Page-1" stroke="none" strokeWidth="1" fill="inherit" fillRule="evenodd">
                <g id="icons8-tasklist" fill="inherit">
...
export default MyContributionIcon;
